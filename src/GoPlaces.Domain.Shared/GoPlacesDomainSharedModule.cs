...
public class GoPlacesDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        GoPlacesGlobalFeatureConfigurator.Configure();
        GoPlacesModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<GoPlacesDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<GoPlacesResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/GoPlaces");

            options.DefaultResourceType = typeof(GoPlacesResource);
        ...
        {
            options.MapCodeNamespace("GoPlaces", typeof(GoPlacesResource));
        });
    }
}
