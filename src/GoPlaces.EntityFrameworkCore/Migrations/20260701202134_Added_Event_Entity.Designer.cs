...
namespace GoPlaces.Migrations
{
    ...
    [Migration("20260701202134_Added_Event_Entity")]
    partial class Added_Event_Entity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoPlaces.Destinations.Destination", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("GoPlaces.Events.Event", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoPlaces.Experiences.Experience", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoPlaces.ExternalApiMetrics.ExternalApiCall", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ExternalApiCalls", (string)null);
                });

            modelBuilder.Entity("GoPlaces.Follows.FollowList", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppFollowLists", (string)null);
                });

            modelBuilder.Entity("GoPlaces.Follows.FollowListItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("FollowListId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("FollowListId", "DestinationId")
                        .IsUnique();

                    b.ToTable("AppFollowListItems", (string)null);
                });

            modelBuilder.Entity("GoPlaces.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoPlaces.Ratings.Rating", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GoPlaces.Destinations.Destination", b =>
                {
                    b.OwnsOne("GoPlaces.Destinations.Coordinates", "Coordinates", b1 =>
                        {
            ...
            modelBuilder.Entity("GoPlaces.Experiences.Experience", b =>
                {
                    b.HasOne("GoPlaces.Destinations.Destination", null)
                        .WithMany()
                        .HasForeignKey("DestinationId")
            ...
            modelBuilder.Entity("GoPlaces.Follows.FollowListItem", b =>
                {
                    b.HasOne("GoPlaces.Follows.FollowList", null)
                        .WithMany("Items")
